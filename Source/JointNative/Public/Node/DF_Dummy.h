 ...
 * 
 * @note It has been initially introduced for level sequencers with Joint Movie track, Because for the nodes that must be played & controlled via the level sequencer, they should never be played by the default playback system, so it must be placed under a Dummy fragment to prevent that.
 * @info From Joint Native 2.16.0, Level Sequencer Track Dummy has been renamed to Dummy Fragment for general purposes.
 */
